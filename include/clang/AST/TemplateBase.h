...
public:
  ...
  /// \param Name The template name.
  ///
  /// \param ExpansionInfo The number of expansions that will be generated by
  /// instantiating
  TemplateArgument(TemplateName Name, ExpansionInfo Expansion) {
    TemplateArg.Kind = TemplateExpansion;
    TemplateArg.Name = Name.getAsVoidPointer();
    TemplateArg.ExpansionInfo = Expansion.getAsEncodedValue();
  }
  ...
  TemplateArgument(DeclarationName Name, ExpansionInfo Expansion) {
  ...
  ExpansionInfo getTemplateExpansionInfo() const;
  ...
  /// expansion will produce, if known.
  ExpansionInfo getDeclNameExpansionInfo() const;
