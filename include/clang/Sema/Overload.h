...
namespace clang {
  ...
  enum ImplicitConversionKind {
    ...
    ICK_StripFunctionProtoDesig, /// < Strip designators from function prototype
  ...
  private:
    ...
    // Allocator for ConversionSequenceLists and MappedArgs. We store the first few of these
  ...
  public:
    ...
    OverloadCandidate &addCandidate(unsigned NumConversions = 0,
      ...
      C.MappedArgs = slabAllocate<Expr *>(NumMappedArgs);
